...
class UpdateSearchFunctionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'key' => [
                ...
                Rule::unique('search_functions')
                    ->where('visible_for', $this->input('visible_for'))
                    ->ignore($this->route('search_function')),
            ],
