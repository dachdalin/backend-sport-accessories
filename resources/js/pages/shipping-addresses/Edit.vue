    ...
    <div class="flex flex-col space-y-6">
        ...
        >
            <div class="grid gap-2">
                ...
                <Select
                    name="customer_id"
                    :default-value="String(props.shippingAddress.customer_id)"
                >
            ...
            <div class="grid gap-2">
                ...
                <Input
                    ...
                    required
                    autofocus
                    :default-value="props.shippingAddress.contact_person_name"
                />
            ...
            <div class="grid gap-2">
                ...
                <Input
                    id="phone"
                    name="phone"
                    :default-value="props.shippingAddress.phone ?? ''"
            ...
            <div class="grid gap-2">
                ...
                <Select
                    name="address_type"
                    :default-value="props.shippingAddress.address_type"
                >
            ...
            <div class="grid gap-2">
                ...
                <Input
                    ...
                    name="address"
                    required
                    :default-value="props.shippingAddress.address"
                />
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        name="city"
                        required
                        :default-value="props.shippingAddress.city"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        id="state"
                        name="state"
                        :default-value="props.shippingAddress.state ?? ''"
                    />
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="grid gap-2">
                    ...
                    <Input
                        id="zip"
                        name="zip"
                        :default-value="props.shippingAddress.zip ?? ''"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        name="country"
                        required
                        :default-value="props.shippingAddress.country"
                    />
            ...
            <div class="flex items-center gap-2">
                <Checkbox
                    id="is_default"
                    name="is_default"
                    :default-value="props.shippingAddress.is_default"
                />
            ...
            <div class="flex items-center gap-4">
                <Button :disabled="processing">Save shipping address</Button>
            </div>
        </Form>
    </div>
</template>
