...
import { edit, index } from '@/routes/stock-clearance-setups';
...
type StockClearanceSetup = {
    ...
    offer_active_range_start: string | null;
    offer_active_range_end: string | null;
...
defineOptions({
    layout: (pageProps: { stockClearanceSetup: StockClearanceSetup }) => ({
        breadcrumbs: [
            {
            ...
            {
                title: `Edit setup #${pageProps.stockClearanceSetup.id}`,
                href: edit(pageProps.stockClearanceSetup),
            },
        ],
    }),
});

const offerActiveTime = ref(props.stockClearanceSetup.offer_active_time);

let nextKey = 0;

function itemFromSetup(item: StockClearanceItem) {
    return {
        key: nextKey++,
...
const items = ref(
    props.stockClearanceSetup.items.length > 0
        ? props.stockClearanceSetup.items.map(itemFromSetup)
        : [{ key: nextKey++, product_id: '', discount_type: 'percent', discount_amount: '' }],
);

function addItem() {
    items.value.push({ key: nextKey++, product_id: '', discount_type: 'percent', discount_amount: '' });
}
...
<template>
    <Head :title="`Edit setup #${stockClearanceSetup.id}`" />

    <div class="flex flex-col space-y-6">
        <Heading
            :title="`Edit setup #${stockClearanceSetup.id}`"
            description="Update this stock clearance campaign and its products"
        />

        <Form
            v-bind="StockClearanceSetupController.update.form(stockClearanceSetup)"
        ...
        >
            <div class="grid grid-cols-2 gap-4">
                <div class="grid gap-2">
                    ...
                    <Select name="discount_type" :default-value="stockClearanceSetup.discount_type">
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        min="0"
                        required
                        :default-value="stockClearanceSetup.discount_amount"
                    />
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        type="date"
                        required
                        :default-value="stockClearanceSetup.duration_start_date"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        type="date"
                        required
                        :default-value="stockClearanceSetup.duration_end_date"
                    />
            ...
            <div v-if="offerActiveTime === 'specific_time'" class="grid grid-cols-2 gap-4">
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        type="time"
                        :default-value="stockClearanceSetup.offer_active_range_start ?? ''"
                    />
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        type="time"
                        :default-value="stockClearanceSetup.offer_active_range_end ?? ''"
                    />
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex items-center gap-2">
                    <Checkbox
                        ...
                        :default-value="stockClearanceSetup.show_in_homepage"
                    />
                ...
                <div class="flex items-center gap-2">
                    <Checkbox
                        ...
                        :default-value="stockClearanceSetup.show_in_homepage_once"
                    />
                ...
                <div class="flex items-center gap-2">
                    <Checkbox
                        id="show_in_shop"
                        name="show_in_shop"
                        :default-value="stockClearanceSetup.show_in_shop"
                    />
                ...
                <div class="flex items-center gap-2">
                    <Checkbox
                        id="is_active"
                        name="is_active"
                        :default-value="stockClearanceSetup.is_active"
                    />
            ...
            <div class="flex items-center gap-4">
                <Button :disabled="processing">Update setup</Button>
            </div>
        </Form>
    </div>
</template>
