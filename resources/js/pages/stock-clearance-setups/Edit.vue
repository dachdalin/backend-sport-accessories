...
<template>
    ...
    <div class="flex flex-col gap-6">
        ...
        <Form
            v-bind="
                StockClearanceSetupController.update.form(stockClearanceSetup)
            "
            ...
            <Card>
                ...
                <CardContent class="grid gap-4 sm:grid-cols-2">
                    <div class="grid gap-2">
                        ...
                        <Select
                            name="discount_type"
                            :default-value="stockClearanceSetup.discount_type"
                        >
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                required
                                :default-value="
                                    stockClearanceSetup.duration_start_date
                                "
                            />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                required
                                :default-value="
                                    stockClearanceSetup.duration_end_date
                                "
                            />
                    ...
                    >
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                type="time"
                                :default-value="
                                    stockClearanceSetup.offer_active_range_start ??
                                    ''
                                "
                            />
                            <InputError
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                type="time"
                                :default-value="
                                    stockClearanceSetup.offer_active_range_end ??
                                    ''
                                "
                            />
                            <InputError
                ...
                <CardContent class="grid gap-3 sm:grid-cols-2">
                    ...
                    >
                        <Checkbox
                            ...
                            :default-value="
                                stockClearanceSetup.show_in_homepage
                            "
                        />
                    ...
                    >
                        <Checkbox
                            ...
                            :default-value="
                                stockClearanceSetup.show_in_homepage_once
                            "
                        />
                        <span class="grid gap-0.5">
                            <span class="text-sm font-medium"
