...
const metaTitle = ref(props.page.meta_title ?? '');
const metaDescription = ref(props.page.meta_description ?? '');
const status = ref(props.page.status);

const previewTitle = computed(() => metaTitle.value || props.page.title);
...
<template>
    ...
    <div class="flex flex-col gap-6">
        <Heading
            title="Edit page"
            :description="`Update the details for ${page.title}`"
        />

        <Form
            v-bind="PageController.update.form(page)"
                ...
                <Card class="lg:sticky lg:top-6">
                    ...
                    <CardContent class="flex flex-col gap-4">
                        ...
                        <p class="text-xs text-muted-foreground">
                            Illustrative search preview, not a live page.
                        </p>
                    </CardContent>
                </Card>
                        ...
                        >
                            ...
                            <span class="grid gap-0.5">
                                ...
                                <span class="text-xs text-muted-foreground"
                                    >Visible to customers while this stays
                                    checked.</span
                                >
                            </span>
                        </label>
