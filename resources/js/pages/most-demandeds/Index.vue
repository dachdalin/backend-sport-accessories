...
defineProps<{
    mostDemandeds: Paginated<MostDemanded>;
}>();
    ...
    <div class="flex flex-col gap-6">
        ...
        >
            <table class="w-full text-left text-sm">
                ...
                <tbody>
                    <tr
                        v-for="mostDemanded in mostDemandeds.data"
                        :key="mostDemanded.id"
                    ...
                    <tr v-if="mostDemandeds.data.length === 0">
                        <td
        ...
        <div
            v-if="mostDemandeds.links.length > 3"
            class="flex flex-wrap items-center justify-center gap-1"
        >
            <template v-for="(link, index) in mostDemandeds.links" :key="index">
                <span
                    v-if="!link.url"
